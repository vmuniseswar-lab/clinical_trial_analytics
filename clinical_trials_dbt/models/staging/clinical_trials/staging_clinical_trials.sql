with source as (
    ...
    select * from {{ source('clinical_trials_raw', 'raw_clinical_trials') }}
...
cleaned as (
    ...
    select
        ...
        safe_cast(enrollment_count as int64)         as enrollment_target,
        ...
        case
            when safe_cast(completion_date as date) < current_date()
